...
sub setCoord{ my $obj = shift; my ($coord) = @_; $obj->{'coord'} = $coord; return 1 }
...
sub createSVGInGroup{
	...
	my $id = $obj->id;
	my $svg = $group->svg( 'id'=>$obj->id, 'onclick'=>"sendid(evt,$id)", 'x'=>$obj->X, 'y'=>$obj->Y, 'fill'=>$main::colortofill{$obj->color}, %options );
	...
	if( $obj->type eq 'pawn' ){
		...
		$innergroup->path(
			'type'=>"arc",
			'style'=>"fill: black; stroke: black; stroke-width: 1.5",
			'cx'=>"8.5",
			'cy'=>"23.5",
			'rx'=>"0.5",
			'ry'=>"0.5",
		...
		$innergroup->path( 'style'=>"stroke:black;stroke-width:1.5", 'd'=>"M 9,36 C 12.385255,35.027671 19.114744,36.430821 22.5,34 C 25.885256,36.430821 32.614745,35.027671 36,36 C 36,36 37.645898,36.541507 39,38 C 38.322949,38.972328 37.354102,38.986164 36,38.5 C 32.614745,37.527672 25.885256,38.958493 22.5,37.5 C 19.114744,38.958493 12.385255,37.527672 9,38.5 C 7.6458978,38.986164 6.6770511,38.972328 6,38 C 7.3541023,36.055343 9,36 9,36 z " );
		$innergroup->path( 'style'=>"stroke:black;stroke-width:1.5", 'd'=>"M 15,32 C 17.5,34.5 27.5,34.5 30,32 C 30.5,30.5 30,30 30,30 C 30,27.5 27.5,26 27.5,26 C 33,24.5 33.5,14.5 22.5,10.5 C 11.5,14.5 12,24.5 17.5,26 C 17.5,26 15,27.5 15,30 C 15,30 14.5,30.5 15,32 z " );
		$innergroup->path(
			'type'=>"arc",
			'style'=>"stroke:black;stroke-width:1.5;",
			'cx'=>"22.5",
		...
		$innergroup->path( 'style'=>"fill: none; stroke: black; stroke-width: 1.5;", 'd'=>"M 17.5,26 L 27.5,26" );
		$innergroup->path( 'style'=>"fill: none; stroke: black; stroke-width: 1.5", 'd'=>"M 15,30 L 30,30" );
		$innergroup->path( 'style'=>"fill: none; stroke: black; stroke-width: 1.5", 'd'=>"M 22.5,15.5 L 22.5,20.5" );
		$innergroup->path( 'style'=>"fill: none; stroke: black; stroke-width: 1.5", 'd'=>"M 20,18 L 25,18", ); }
	elsif( $obj->type eq 'rook' ){
		$innergroup->path( style=>"stroke:black;stroke-width:1.5", d=>"M 9,39 L 36,39 L 36,36 L 9,36 L 9,39 z " );
		$innergroup->path( style=>"stroke:black;stroke-width:1.5", d=>"M 12,36 L 12,32 L 33,32 L 33,36 L 12,36 z " );
		$innergroup->path( style=>"stroke:black;stroke-width:1.5", d=>"M 11,14 L 11,9 L 15,9 L 15,11 L 20,11 L 20,9 L 25,9 L 25,11 L 30,11 L 30,9 L 34,9 L 34,14" );
		$innergroup->path( style=>"stroke:black;stroke-width:1.5", d=>"M 34,14 L 31,17 L 14,17 L 11,14" );
		$innergroup->path( style=>"stroke:black;stroke-width:1.5", d=>"M 31,17 L 31,29.500018 L 14,29.500018 L 14,17" );
		$innergroup->path( style=>"stroke:black;stroke-width:1.5", d=>"M 31,29.5 L 32.5,32 L 12.5,32 L 14,29.5" );
		$innergroup->path( style=>"stroke:black;stroke-width:1.5", d=>"M 11,14 L 34,14" );
	}
	elsif( $obj->type eq 'king' ){
		$innergroup->path(
		...
		$innergroup->path(
			'type'=>"arc", 'style'=>"stroke:black;stroke-width:1.5",
			'cx'=>"7", 'cy'=>"13", 'rx'=>"2", 'ry'=>"2",
		...
		$innergroup->path( 'style'=>"stroke:black;stroke-width:1.5", 'd'=>"M 9, 26 C 17.5, 24.5 30, 24.5 36, 26 L 38, 14 L 31, 25 L 31, 11 L 25.5, 24.5 L 22.5, 9.5 L 19.5, 24.5 L 14, 10.5 L 14, 25 L 7, 14 L 9, 26 z " );
		$innergroup->path( 'style'=>"stroke:black;stroke-width:1.5", 'd'=>"M 9, 26 C 9, 28 10.5, 28 11.5, 30 C 12.5, 31.5 12.5, 31 12, 33.5 C 10.5, 34.5 10.5, 36 10.5, 36 C 9, 37.5 11, 38.5 11, 38.5 C 17.5, 39.5 27.5, 39.5 34, 38.5 C 34, 38.5 35.5, 37.5 34, 36 C 34, 36 34.5, 34.5 33, 33.5 C 32.5, 31 32.5, 31.5 33.5, 30 C 34.5, 28 36, 28 36, 26 C 27.5, 24.5 17.5, 24.5 9, 26 z " );
